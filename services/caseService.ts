...
export async function createCase(data: { subject: string; description?: string; priority?: string; origin?: string; type?: string; contactId?: string; accountId?: string; supportTier?: string }): Promise<Partial<SFCase>> {
